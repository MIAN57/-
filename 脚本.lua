...
credits:Button("VexonHub", function()
   loadstring(game:HttpGet("https://raw.githubusercontent.com/Tax-Script/TaxHub/refs/heads/main/VexonHub"))()
    end)
...
credits:Button("自动格挡-Novahitta", function()
   loadstring(game:HttpGet("https://raw.githubusercontent.com/MIAN57/-/refs/heads/main/obfuscated_script-1759647027372.lua.txt"))()
end)
